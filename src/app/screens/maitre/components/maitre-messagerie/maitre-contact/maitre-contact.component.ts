...
@Component({
  selector: 'app-maitre-contact',
  templateUrl: './maitre-contact.component.html',
  styleUrls: ['./maitre-contact.component.scss']
})
export class MaitreContactComponent implements OnInit {
