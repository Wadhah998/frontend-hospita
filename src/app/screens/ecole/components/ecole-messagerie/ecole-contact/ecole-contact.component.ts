...
@Component({
  selector: 'app-ecole-contact',
  templateUrl: './ecole-contact.component.html',
  styleUrls: ['./ecole-contact.component.scss']
})
export class EcoleContactComponent implements OnInit {
